...
export const users = pgTable("users", {
  ...
  avatarPositionX: integer("avatar_position_x").default(50),
  avatarPositionY: integer("avatar_position_y").default(50),
  avatarScale: integer("avatar_scale").default(100),
...
export const notifications = pgTable("notifications", {
  id: serial("id").primaryKey(),
  userId: integer("user_id").notNull().references(() => users.id),
  type: varchar("type", { length: 50 }).notNull(), // 'new_subscriber', 'new_comment', etc.
